...
router.get('/api/:id', employeeController_1.default.getEmployeeById);
router.get('/name', employeeController_1.default.getEmployeeByName);
router.get('/dept/:id', employeeController_1.default.getEmployeesOfSameDepartment);
